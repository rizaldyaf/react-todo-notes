...
class Notes extends Component {
    ...
    render() {
        ...
        let renderedNotes = this.props.Session.data.notes
        renderedNotes.sort((a, b) => new Date(b.dateModified) - new Date(a.dateModified));
        return (
            ...
            <div className='pageWrapper'>
                <div className='pageContent'>
                    <div className='gridView'>
                        {renderedNotes.map((note, index)=><div className='noteWrapper' key={index} style={{zIndex:this.state.contextMenuIndex === index?1000 + index:index}}>
                            <div 
                                className={"noteblock"} 
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(Notes) ))
